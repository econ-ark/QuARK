...
# %% code_folding=[3]
#Setting all parameters exceot the discount factor to their default values to define betaMax:
UnempPrb = 0.00625    # Prob of becoming unemployed; working life of 1/UnempProb = 160 qtrs
Rfree = 1.01         # Risk-free interest factor on assets
PermGroFac = 1.0025 # Permanent income growth factor (uncompensated)
CRRA = 2.5

# Define maximal discount factor where the growth impatience factor equals unity
betaMax = ((PermGroFac/(1-UnempPrb))**CRRA)/(Rfree*(1-UnempPrb))
...
# %% [markdown]
# ## Solution
# As the consumer gets more and more patient, i.e. as he discounts the future less, the stronger he figures the possibility of becoming unemployed into today's consumption decision. This factoring in leads him to save more for the likely case of future unemployment in which he will have to finance his consumption solely from his savings for the rest of his existence. Thus, as beta increases the desire to save grows, which increases the optimal savings level and reduces the consumer's marginal propensity to consume.
