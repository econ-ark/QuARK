...
# %%
dist20 = SCF_Lorenz_points[40]-sim_Lorenz_points[40]
dist40 = SCF_Lorenz_points[80]-sim_Lorenz_points[80]
dist60 = SCF_Lorenz_points[120]-sim_Lorenz_points[120]
dist80 = SCF_Lorenz_points[160]-sim_Lorenz_points[160]
dist = np.linalg.norm([dist20, dist40, dist60, dist80])
print(dist)
...
MPCpercentiles_quarterly = getPercentiles(MPC_sim,percentiles=percentiles)
MPCpercentiles_annual = 1.0 - (1.0 - MPCpercentiles_quarterly)**4
print('The 35th percentile of the MPC is '+str(decfmt2(MPCpercentiles_annual[6])))
...
# %%
percentiles=np.linspace(0.1,0.9,100)
MPC_sim = np.concatenate([ThisType.MPCnow for ThisType in NewTypes])
MPCpercentiles_quarterly = getPercentiles(MPC_sim,percentiles=percentiles)
MPCpercentiles_annual = 1.0 - (1.0 - MPCpercentiles_quarterly)**4

LargerThan7 = np.where(MPCpercentiles_annual>0.70)
print(LargerThan7)
print(str(decfmt2((1-percentiles[91])*100)) + ' % are hand to mouth')
# test
