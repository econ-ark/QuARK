...
Psi = TBS_dictionary['PermGroFac']/(1 - TBS_dictionary['UnempPrb'])
betamax = Psi**TBS_dictionary['CRRA'] / (TBS_dictionary['Rfree'] * (1 - TBS_dictionary['UnempPrb']))
betamax

# %%
# b) modify DiscFac_widget
DiscFac_widget = widgets.FloatSlider(
    min=betamin,
    max=betamax - 0.01,
    step=0.0002,
